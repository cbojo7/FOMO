"""
Django settings for FamilyOrientedMusicOperation project.
...
SECRET_KEY = '9#^k)=1^39!qphu2l&vde1dk*39l7*_39a*27skyr%yh@$e$lo'
...
WSGI_APPLICATION = 'FamilyOrientedMusicOperation.wsgi.application'
